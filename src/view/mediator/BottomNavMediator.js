        ...
        switch( signal )
        {
            case rps.BottomNavComponent.SIGNAL_NEXT:
                this.sendNotification( rps.AppConstants.NOTE_PAGE_CHANGE,
                    new rps.ChangeObject( rps.AppConstants.PAGE_CHANGE_DIRECTION, rps.BottomNavComponent.SIGNAL_NEXT ) );
                break;
               
            case rps.BottomNavComponent.SIGNAL_PREVIOUS:
                this.sendNotification( rps.AppConstants.NOTE_PAGE_CHANGE,
                    new rps.ChangeObject( rps.AppConstants.PAGE_CHANGE_DIRECTION, rps.BottomNavComponent.SIGNAL_PREVIOUS ) );
                break;
